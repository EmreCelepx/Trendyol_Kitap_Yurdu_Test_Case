...
public class Ty_GirisSenaryo03 {
    @Test
    public void test01() {
        ...
        Assert.assertEquals(expectedUrl, acttualUrl);
        //8	Hesabım'a git
        WebElement accountBox = driver.findElement(By.xpath("//p[@class='link-text' and text()='Hesabım']"));
        accountBox.click();
        //9	İsim bölümünün hesap adıyla örtüştüğünü doğrula	Emre CELEP
        String expectedName = "Emre Celep";
        WebElement actualName = driver.findElement(By.xpath("//section[@class='section-user_info']/p"));
