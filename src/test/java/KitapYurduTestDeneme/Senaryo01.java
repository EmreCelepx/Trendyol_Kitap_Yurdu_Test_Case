...
public class Senaryo01 {
    ...
    public void test01(){
      ...
      //10  Kayıt işleminin tamamlanmadığını doğrula
             String expectednoNameError = "Ad alanı 2 ile 30 karakter arasında olmalı!";
             WebElement noNameError = driver.findElement(By.xpath("//span[text()='Ad alanı 2 ile 30 karakter arasında olmalı!']"));
